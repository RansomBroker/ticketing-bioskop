...
<body>
    <div class="w-full min-h-screen bg-[url('/img/background.png')] bg-repeat flex justify-center  items-center lg:p-10 md:py-4 py-4 ">
        <div class="w-full h-fit md:w-1/3 lg:w-1/3  bg-gradient-to-t from-[#D9D9D9B3] rounded-3xl p-4">
            ...
            @endif
            <form class="w-full" method="POST" action="{{ URL::to('/register/process') }}">
                <div class="mb-3">
                ...
                <button type="submit" class="transition ease-in-out delay-150 w-full p-2 rounded-md uppercase text-center bg-[#CCB443] font-bold shadow-lg my-3 hover:-translate-y-0.5 hover:scale-105 hover:bg-[#FFC107] cli duration-300">Daftar</button>
            </form>
        </div>
    </div>
</body>
