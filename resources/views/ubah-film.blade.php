        ...
        <div class="flex flex-col min-h-screen bg-[url('/img/background.png')] bg-repeat">
            ...
            <div class=" w-full flex justfy-center p-8">
                <div class="w-full p-8 rounded bg-[#595959] text-white">
                    <h1  class=" text-center  text-[#CCB443] text-xl drop-shadow-xl font-extrabold uppercase ">Ubah film</h1>
                    <form>
                        <div class="mb-3">
                            <label class="font-bold">Judul Film</label>
                            <input type="text" class="text-black w-full rounded p-1 focus:outline-amber-300 focus:outline focus:outline-2" id="Judul Film" name="Judul Film" placeholder="Judul Film ">
                        </div>
                        <div class="mb-3">
                            <label class="font-bold">Sinposis Film</label>
                            <textarea class=" text-black w-full rounded p-1 focus:outline-amber-300 focus:outline focus:outline-2" id="Sinopsis" name="Sinopsis" placeholder="Sinopsis "></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="font-bold">Rating Usia</label>
                            <select class="text-black w-full rounded p-1 focus:outline-amber-300 focus:outline focus:outline-2" name="" id="">
